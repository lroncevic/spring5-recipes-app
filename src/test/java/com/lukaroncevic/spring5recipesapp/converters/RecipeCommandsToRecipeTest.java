...
import com.lukaroncevic.spring5recipesapp.domain.Difficulty;
...
class RecipeCommandsToRecipeTest {
    ...
    RecipeCommandsToRecipe converter;

    @BeforeEach
    void setUp() {
        converter = new RecipeCommandsToRecipe(new CategoryCommandToCategory(),
